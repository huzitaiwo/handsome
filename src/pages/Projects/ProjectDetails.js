        ...
        <>
          <section>
            <div className="container">
              ...
              <p className={`project-heading secondary ${mode}`}>
                {project.type}
              </p>
            </div>
            <div className="container project-main-image">
              ...
              <div className="project-grid">
                ...
                <div className="project-description">
                  ...
                  <a
                    ...
                    rel="noreferrer"
                  >
                    View project <img src={arrowRight} alt="visit website" />
                  </a>
                </div>
              </div>
              <div className="gallery">
                {project.gallery &&
                  project.gallery.map((image, i) => (
                    <img key={i} src={image} alt="project gallery" />
                  ))}
              </div>
            </div>
          </section>
